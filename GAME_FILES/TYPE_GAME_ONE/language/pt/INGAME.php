...
$LNG['type_mission'][18] 					= 'Expedição';
$LNG['type_mission'][16] 					= 'Asteroids';
$LNG['type_mission'][17] 					= 'Setor hostil';
...
$LNG['lm_fleettrader']						= 'Mercado Frotas';
...
$LNG['gl_populed_planets']					= 'Planetas existentes';
...
$LNG['bd_cancel_warning']                   = 'ATENÇÃO! <br> Se cancelares só receberás 50% dos teus recursos investidos.';
...
$LNG['al_rank_desc']['BANK']            = 'Usando aliança bancária';
$LNG['al_rank_desc']['BANKISSUE']            = 'Usando compartilhamento bancário';
$LNG['al_rank_desc']['PLANETS']            = 'Use os planetas da aliança';
...
$LNG['cff_mission_own_hostile_0']				= 'Um dos seus %s de %s %s %s atingiu a posição %s. missão: %s (%s)';
$LNG['cff_mission_own_hostile_1']				= 'Um dos seus %s retorna da posição %s back to %s %s %s. missão: %s (%s)';
$LNG['cff_mission_own_hostile_2']				= 'Um dos seus %s de %s %s %s está em uma expedição para posição %s. missão: %s (%s)';
