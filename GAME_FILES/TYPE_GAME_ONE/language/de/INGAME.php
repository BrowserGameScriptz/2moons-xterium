...
$LNG['type_mission'][18] 					= 'Expedition';
$LNG['type_mission'][16] 					= 'Asteroid';
...
$LNG['lm_buddylist']						= 'Freundes Liste';
...
$LNG['ov_teamspeak_not_online']				= 'Teamspeak Server zurzeit nicht erreichbar. Wir bitten um Verständnis.';
...
$LNG['gl_short_friend']						= '';
$LNG['gl_short_member']						= '';
$LNG['gl_populed_planets']					= 'Planeten besiedelt';
...
$LNG['gl_show']								= 'Anzeigen'; //Änderung /
$LNG['gl_pos']								= 'Pos.'; //Änderung /
...
$LNG['gl_buddy_request']					= 'Freundschaftsanfrage';
...
$LNG['gl_ajax_status_ok']					= 'Erledigt';
$LNG['gl_ajax_status_fail']					= 'Fehler';
...
$LNG['px_out_of_range']						= 'außer Reichweite';
...
$LNG['fl_shortcut_edition']					= 'Shortcut ändern';
...
$LNG['fl_empty_target']						= 'Es sind keine Missionen. <br><br> Mögliche Ursachen: <br> • Die Zusammensetzung der Flotte Verstößt gegen die Missionen <br> • Der Planet ist nicht vorhanden';
...
$LNG['fl_bash_protection']					= 'Überschritten die Zahl der Angriffe pro Tag an diesem Ziel.';
...
$LNG['bd_building_shipyard']				= 'Es ist unmöglich, Schiffe zu bauen, solange sich die Werft oder die Nanitenfabrik verbessert.';
$LNG['bd_available']						= 'Vorhanden: ';
$LNG['bd_build_ships']						= 'Absenden';
$LNG['bd_protection_shield_only_one']		= 'Sie können nur %s Schildkuppel Bauen!';
...
$LNG['bd_cancel_warning']					= 'Bei Abbruch werden nur 50% der Ressourcen wiederhergestellt!';
...
$LNG['al_make_ally_insufficient_points']	= 'Du hast nicht genug dunke materie, um eine Allianz zu gründen.<br>Du benötigst mindestenst %s dunke materie, dir fehlern %s dunke materie.';
...
$LNG['al_rank_desc']['BANK']         		= 'Verwendung Bank Allianz'; 
$LNG['al_rank_desc']['BANKISSUE']      		= 'verwenden Bank ausgabe';
$LNG['al_rank_desc']['PLANETS']      		= 'Benutzt die Planeten der Allianz';
$LNG['al_invalid_rank_name']				= 'Im Ranknamen sind nur Zahlen, Buchstaben, Leerzeichen, _, -, . erlaubt!';


//----------------------------------------------------------------------------//
//BUDDY
$LNG['bu_request_exists']					= 'Spieler bereits in der Freundesliste!';
$LNG['bu_cannot_request_yourself']			= 'Du kannst dich nicht selbst in die Freundesliste hinzufügen!';
...
$LNG['bu_buddy_list']						= 'Freundesliste';
...
$LNG['bu_partners']							= 'Freunde';
$LNG['bu_delete']							= 'Löschen';
$LNG['bu_no_request']						= 'Keine Anfragen vorhanden!';
$LNG['bu_no_buddys']						= 'Keine Freunde vorhanden!';
$LNG['bu_request_send']						= 'Anfrage gesendet!';
$LNG['bu_new_request_title']				= 'Neue Freundesliste-Anfrage!';
$LNG['bu_new_request_body']					= 'Hallo %s,<br>%s hat dir eine Freundesliste-Anfrage gesendet!';
$LNG['bu_accepted_request_title']			= 'Freundesliste-Anfrage akzeptiert!';
$LNG['bu_accepted_request_body']			= 'Hallo %s,<br>%s hat deine Freundschaftsanfrage angenommen!';
$LNG['bu_rejected_request_title']			= 'Freundesliste-Anfrage abgelehnt!';
$LNG['bu_rejected_request_body']			= 'Hallo %s,<br>%s hat deine Freundschaftsanfrage abgelehnt!';
...
$LNG['st_achievements']                   = 'Erfolge';
$LNG['st_wapeonry']                       = 'Bewaffnung'; //Wapeonry
$LNG['st_voted']                       = 'Stimmen';
...
$LNG['op_add_to_buddy_list']				= 'Zur Freundesliste hinzufügen';
$LNG['op_missile_attack']					= 'Raketenangriff';
$LNG['op_send_report']						= 'Spionage Report';
...
$LNG['op_spy_probes_number_descrip']		= 'Anzahl der Spionagesonden, die bei jedem Scan aus dem Galaxiemenü direkt versendet werden.';
$LNG['op_activate_vacation_mode_descrip2'] = 'Sind Sie sicher, dass Sie den Urlaubs-Modus aktivieren wollen';
$LNG['op_activate_vacation_mode_descrip']	= 'Der Urlaubsmodus soll während längerer Abwesenheitszeiten schützen. Man kann ihn nur aktivieren, wenn nichts gebaut und/oder geforscht wird und auch keine eigenen Flotten unterwegs sind. Ist er aktiviert, schützt er dich vor neuen Angriffen. Bereits begonnene Angriffe werden jedoch fortgesetzt. Während des Urlaubsmodus wird die Produktion auf Null gesetzt und muss nach Beenden des Urlaubsmodus manuell wieder auf 100% gesetzt werden. Der Urlaubsmodus Dauert mindestens 2 Tage, erst danach kannst du ihn wieder deaktivieren.';
...
$LNG['op_user_name_no_alphanumeric']		= 'Bitte beim Username nur alphanumerische Zeichen verwenden!';
$LNG['op_change_name_pro_week']				= 'Du kannst deinen Usernamen nur 1x pro Woche ändern';
...
$LNG['cff_mission_own_hostile_0']				= 'Eine deiner %s vom %s %s %s erreicht die Position %s. Mission: %s (%s)';
$LNG['cff_mission_own_hostile_1']				= 'Eine deiner %s kehrt von der Position %s zurück zum %s %s %s. Mission: %s (%s)';
$LNG['cff_mission_own_hostile_2']				= 'Eine deiner %s vom %s %s %s ist auf einer Expedition bei Position %s. Mission: %s (%s)';
...
$LNG['sys_refferal_text']        	 		= 'Der von dir geworbene Spieler %s hat nun %s Punkte erreicht.<br><br>Als Dankeschön, dass du einen aktiven Spieler geworben hast, erhältst du %s %s %s %s';
...
$LNG['pl_unitsshot']    					= 'Geschossene Einheiten';
$LNG['pl_unitslose']    					= 'Verlorene Einheiten';
...
$LNG['ti_create_info']						= '<p>Bitte vergib beim erstellen einer neuen Anfrage einen möglichst aussagekräftigen Betreff und schildern das Anliegen so detailliert wie möglich.</p>
<p>Eine genaue Beschreibung deiner Anfrage ermöglicht kurze Bearbeitungszeiten und vermeidet zeitaufwendige Rückfragen auf beiden Seiten.</p>
<p>Bei Account bezogenen Fragen erleichtert die Angabe des entsprechenden Kundenaccounts die Zuordnung und verkürzt ebenfalls die Bearbeitungsdauer.</p>';
...
$LNG['bs_add_acs_slot']						= 'AKS-Slot hinzufügen';
$LNG['bs_reset']							= 'Reset';
//----------------------------------------------------------------------------//
// Fleettrader
...
// Erweitert bzw. verändert by Nore 2017
