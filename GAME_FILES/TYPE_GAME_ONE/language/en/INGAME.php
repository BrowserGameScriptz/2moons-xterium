...
$LNG['type_mission'][17] 					= 'Hostile Sector';
...
$LNG['lm_fleettrader']						= 'Fleet Merchant';
...
$LNG['gl_populed_planets']					= 'Existing planets';
...
$LNG['fl_my_moons']					  		= 'My moons';
$LNG['fl_acs_title']						= 'Alliance attack';
$LNG['fl_hold_time']						= 'At Flying';
$LNG['fl_resources']						= 'Resources';
$LNG['fl_max']								= 'max';
$LNG['fl_hours']                            = 'Hours';
$LNG['fl_resources_left']				    = 'Capacity available';
$LNG['fl_all_resources']			        = 'All resources';
$LNG['fl_multi_alarm']						= 'Multi alarm!';
$LNG['fl_empty_target']						= 'There are no missions. <br><br> Possible reasons: <br> • The composition of the fleet in breach of missions <br> • The planet does not exist';
$LNG['fl_expedition_alert_message']		    = 'Attention! Explorations are dangerous missions, you can lose your fleet!';
$LNG['fl_dm_alert_message']                 = 'Beware, fleets are destroyed if you find %s with the mission %s!';
$LNG['fl_vacation_mode_active']			    = 'Vacation mode active';
$LNG['fl_expedition_fleets_limit']		    = 'No slots of Exploration available!';
...
$LNG['fl_no_slots']							= 'Without slots available';
...
$LNG['fl_bash_protection']					= 'Exceeded the number of attacks per day at this destination.';
...
$LNG['bd_building_shipyard']				= 'It is impossible to build ships as long as the shipyard or the nanite factory is improving.';
$LNG['bd_available']						= 'Available: ';
$LNG['bd_build_ships']						= 'Build';
$LNG['bd_protection_shield_only_one']		= 'You can only build the shield %s time!';
...
$LNG['bd_cancel_warning']                   = 'ATTENTION! If you cancel only will receive 50% of your resources s invested.';
...
$LNG['in_missilesamount']    				= 'Number of Missiles available';
...
$LNG['al_rank_desc']['BANK']            = 'Using bank alliance';
$LNG['al_rank_desc']['BANKISSUE']            = 'Using bank issue';
...
$LNG['al_make_ally_insufficient_points']	= 'You have not enough darkmatter to create an Alliance.<br>It is required %s darkmatter, you are missing %s darkmatter.';
...
$LNG['st_achievements']                   = 'Achievements';
...
$LNG['op_activate_vacation_mode_descrip2'] = 'Are you sure you want to enable the holiday mode';
$LNG['op_activate_vacation_mode_descrip']	= 'Vacation mode protects your account for as long as you are out of the game. But you can only activate it if you have nothing in construction (buildings, fleet, or defense), and nothing being searched. Once activated. Attacks that had already been posted before will continue during the holidays, the production is put at 0% when entering vacation mode. Activate the holidays mode are bound to remain so for a minimum time of 24 hours.';
...
$LNG['cff_mission_own_hostile_0']				= 'One of your %s from %s %s %s reached the Position %s. Mission: %s (%s)';
$LNG['cff_mission_own_hostile_1']				= 'One of your %s returns from the Position %s back to %s %s %s. Mission: %s (%s)';
$LNG['cff_mission_own_hostile_2']				= 'One of your %s from %s %s %s is on a Expedition to Position %s. Mission: %s (%s)';
...
$LNG['sys_refferal_text']        	 		= 'The player %s recruited by you reached %s points.<br><br>You invite a player active, will be rewarded %s %s and %s %s';
