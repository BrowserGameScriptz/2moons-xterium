...
$LNG['main_nav_2'] = 'VEKIPEDI';
$LNG['main_nav_3'] = 'Kayit';
$LNG['main_nav_4'] = 'E-posta';
$LNG['main_nav_5'] = 'Sifre';
$LNG['main_nav_6'] = 'Giris';
$LNG['main_nav_7'] = 'sifresini Restore';
$LNG['main_nav_8'] = 'Ana';
$LNG['main_nav_9'] = 'Oyun hakkinda';
$LNG['main_nav_10'] = 'Forum';
$LNG['main_nav_11'] = 'Vikipedi';
$LNG['main_nav_12'] = 'bedava oyun';
$LNG['main_nav_13'] = 'oyunu baslatin';
$LNG['main_nav_14'] = 'Oyun haberleri';
$LNG['main_nav_15'] = 'Yeni bir hesap olustur';
$LNG['main_nav_16'] = 'Kullanim Kosullari';
$LNG['main_nav_17'] = 'Tüm haklari saklidir.';
$LNG['main_nav_18'] = 'Oyun';
$LNG['main_nav_19'] = 'Hesap';
$LNG['main_nav_20'] = 'Toplum';
$LNG['main_nav_21'] = 'Sunucu durumu';
$LNG['main_nav_22'] = 'Oyuncular';
$LNG['main_nav_23'] = 'Yeni bu ay';
$LNG['main_nav_24'] = 'Yeni bugün';
$LNG['main_nav_25'] = 'Aktif oyuncular';
$LNG['main_nav_26'] = 'En son konular';
$LNG['main_nav_27'] = 'Foruma Git';
$LNG['main_nav_28'] = 'Diger Haberler';
$LNG['main_nav_29'] = 'Son Makaleler';
$LNG['main_nav_30'] = 'Xterium - gerçek zamanli bir uzay strateji. Ayni anda dünyanin dört bir yanindan binlerce oyuncuyla mücadele en iyi olmak için. Bunu yapmak için, normal bir tarayiciya ihtiyaciniz var. Ekonomik ve askeri altyapisini olusturun. En son teknolojiyi kesfedin. Diger imparatorluklar karsi savasti. Ittifaklar olusturmak ve diger imparatorlarin ile müzakereleri yürütmek. Yenilmez donanmasi ya da gezegensel savunma olusturun. ';
$LNG['main_nav_31'] = 'Uzay, Strateji Online Oyun, ogame, savas, yüksek hiz, 2moons, galaksi';
$LNG['main_nav_32'] = 'Latestt haber';

//ERROR404
$LNG['error_404_1'] = 'Sayfa bulunamadi';
$LNG['error_404_2'] = 'Istediginiz sayfa web sitemizde mevcut degildir adresi yazarak veya yanlis linke gittigimde bir hata yapmis olabilir <br>..';
$LNG['error_404_3'] = 'Yazilisi kontrol et';
$LNG['error_404_4']				= '<a style="color:#0099ff; text-decoration:none; font-size: 14px;" href="/">Ana sayfaya </a>git';

//LOSTPASSWORD
$LNG['lost_pass_1'] = 'e-mail adresinizi girin';
$LNG['lost_pass_2'] = 'gizli bir kod göndermek oyun, e-mail adresinizi girin. Gizli kod sadece 24 saat için geçerli olacak. ';
$LNG['lost_pass_3'] = 'Bir mektup göndermek';

//PROMO
$LNG['promo_1'] = 'Bu sadece bir tarayici ihtiyaci';
$LNG['promo_2'] = 'Sen oyunlarin gigabayt, her sey tarayicinizda çalisiyor indirmek için beklemek gerekmez Xterium oynamaya baslayin. Su anda evrenin fethinden git! ';
$LNG['promo_3'] = 'istediginiz sekilde oynayin';
$LNG['promo_4'] = 'Sen, belirli bir plan üzerinde oynamak kendi stratejilerini gelistirmek zorunda degilsiniz. Academy tesviye yoluyla güçlü ve zayif yönlerin yararlanan, evrendeki tahakküme dogru yolda durmak! ';
$LNG['promo_5']				= 'Akademinin Her sube, gelecekteki savaslar sonucu tanimlayan yükseltme essiz bir güç-ups vardir.';
$LNG['promo_6'] = 'diger oyuncular ile etkilesim';
$LNG['promo_7'] = 'savasi duyuran ittifaklar, diger oyuncular ile ticaret, senin imparatorlugunun hedeflere ulasmak için kendi politikasini insa edebilirsiniz. Siz bagimsiz ya da bu oyuncu ile iliskiler kurmak için nasil belirleyebilirsiniz. ';
$LNG['promo_8'] = 'barisçil diplomat ya da tehdit diktatör olun, size kalmis!';
$LNG['promo_9'] = 'oyunu bir ekip istihdam';
$LNG['promo_10'] = 'Sizin için oyun en ilginç ve heyecan verici hale getirmek için çalistik, bu yüzden continuely üzerinde çalisiyoruz';
$LNG['promo_11'] = 'Constant güncellemeleri.';
...
$LNG['promo_13'] = 'Oyun içi yarismalar.';
$LNG['promo_14']				= 'Oyun çesitlendirmek için, <a href="../index.php?page=news">Yarisma</a> ve <a href="../index.php?page=news">hisselerin</a> her türlü yürütmek için çalisin';
$LNG['promo_15'] = 'Biz geribildirim için tesekkür ederiz.';
$LNG['promo_16']				= 'Eger fikir veya yorumlariniz varsa biz, bizim oyunculara dinlemek, <a href="https://forum.warofgalaxyz.com"> forumu </a> bunlari yaziniz. Belki bu senin teklifin sonraki yama ile hayata geçirilecek olan.';
$LNG['promo_17'] = 'evrensel ölçekte Tarayici online strateji <br>';
$LNG['promo_18'] = 'bedava oyun';

//REGISTER
$LNG['register_1'] = 'Yeni bir hesap olustur';
$LNG['register_2'] = 'Sizi girilen verilerin gizliligini garanti.';
$LNG['register_3'] = 'Bu geçerli olmalidir. Giris sirasinda gerekli <br>. ';
$LNG['register_4'] = 'oyununa Girisi';
$LNG['register_5'] = 'Bu isim altinda bilecek diger oyuncular. Harf ve rakam kullanin. ';
$LNG['register_6'] = 'Sifre oyunu';
$LNG['register_7'] = 'Not az 6 karakter. <br> kullanin harfler ve rakamlar. ';
$LNG['register_8'] = 'Evren';
$LNG['register_9'] = 'Açiklama evrenler';
$LNG['register_10'] = 'görüntüden karakterleri girin';
$LNG['register_11'] = 'Bir robot degildir dogrulayin.';
$LNG['register_12'] = 'OYNAMAK';
$LNG['register_13']	= '<a href="../index.php?page=agreement" target="_blank">Play tiklayarak, bizim kullanici sözlesmesini kabul</a> ';
$LNG['register_14'] = 'open 10.12.15';
$LNG['register_15'] = 'kaynak çikarma orani';
$LNG['register_16'] = 'insaat Hiz';
$LNG['register_17'] = 'arastirma Hiz';
$LNG['register_18'] = 'hiz sefer';
$LNG['register_19'] = 'filo uçus hizi';
$LNG['register_20'] = 'Yeni baslayanlar korunmasi için puan farki';
$LNG['register_21'] = 'Donanma fragmanlari düsüyor';
$LNG['register_22'] = 'Savunma fragmanlari düsüyor';
$LNG['register_23'] = 'yüksek';
$LNG['register_24'] = 'orta';
...
$LNG['login_error_5']				= 'Bu hesap yasak, bir forum bilet açmak lütfen';
$LNG['login_error_6']				= 'Oyun kapalı, daha sonra tekrar deneyiniz';
