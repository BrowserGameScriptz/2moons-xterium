...
$LNG['type_mission'][18] 					= 'Expedición';
$LNG['type_mission'][16] 					= 'Asteroids';
$LNG['type_mission'][17] 					= 'Sector hostil';
...
$LNG['lm_fleettrader']						= 'Mercader Flotas';
...
$LNG['fl_bash_protection']					= 'Se ha superado el número de ataques por día en este destino.';
...
$LNG['bd_cancel_warning']					= 'Durante la demolición, sólo el 50% de los recursos se restaurará.';
...
//----------------------------------------------------------------------------//
//ALLIANCE
$LNG['al_invalid_rank_name']				= 'En el nombre de Rango son sólo números, letras, espacios, _, -. ¡permitido!';
$LNG['al_make_ally_insufficient_points']	= 'Usted no tiene suficiente darkmatter para crear una Alianza.<br>Se requiere %s materia oscura, se echa en falta %s materia oscura.';
...
$LNG['al_rank_desc']['BANK']           		= 'Utilizar alianza bancaria';
$LNG['al_rank_desc']['BANKISSUE']      		= 'Utilizar alianza bancaria emision';
$LNG['al_rank_desc']['PLANETS']      		= 'Usa los planetas de la alianza';
...
$LNG['st_achievements']                   = 'Logros';
$LNG['st_wapeonry']                       = 'Armas';
$LNG['st_voted']                       = 'Votos';
...
$LNG['op_activate_vacation_mode_descrip2'] = '¿Seguro que desea habilitar el modo de vacaciones';
...
$LNG['cff_mission_own_hostile_0']				= 'Una %s de %s %s %s se dirige a %s. Misi&oacute;n: %s (%s)';
$LNG['cff_mission_own_hostile_1']				= 'Una %s Vuelve de %s  hacia %s %s %s. Misi&oacute;n: %s (%s)';
$LNG['cff_mission_own_hostile_2']				= 'Una %s de %s %s %s va de expedici&oacute;n m&aacute;s alla de la posici&oacute;n %s. Misi&oacute;n: %s (%s)';
