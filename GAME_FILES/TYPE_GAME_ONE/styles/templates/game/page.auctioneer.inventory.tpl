            ...
            <div class="ach_menu">
                <ul>
                    ...
                    <li class="skils3 active">
                        <a><img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/planets.png" style="margin-right: 15px;"></a>
                    </li>
					
					<li class="skils3 active" style="margin-top:160px;">
                        <a><img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/build.png" style="margin-right: 15px;"></a>
                    </li>
					
					<li class="skils3 active" style="margin-top:160px;">
                        <a><img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/fleet.png" style="margin-right: 15px;"></a>
                    </li>
