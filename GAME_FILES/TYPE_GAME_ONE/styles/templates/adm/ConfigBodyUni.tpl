...
<tr>
	...
	<td>Support Auto Reply<br></td>
	<td><input name="support_auto"{if $support_auto} checked="checked"{/if} type="checkbox"></td>
	<td>&nbsp;</td>
</tr><tr>
...
<tr>
	<th colspan="2">Paiement options</th><th>&nbsp;</th>
</tr>
<tr>
	<td>Red bonus button</td>
	<td><input name="red_button" maxlength="11" size="11" value="{$red_button}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Multiple dm received by red bonus button"></td>
</tr>
<tr>
	<td>Purchase Bonus</td>
	<td><input name="donation_bonus" maxlength="11" size="11" value="{$donation_bonus}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Extra antimatter on each purchase"></td>
</tr><tr>
	<td>Extra purchase status</td>
	<td><input name="special_donation_status"{if $special_donation_status} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Activate special paiement promotion"></td>
</tr><tr>
	<td>Extra purchase amount</td>
	<td><input name="special_donation_amount" maxlength="11" size="11" value="{$special_donation_amount}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Minimal extra paiement amount"></td>
</tr><tr>
	<td>Extra purchase percent</td>
	<td><input name="special_donation_percent" maxlength="11" size="11" value="{$special_donation_percent}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Extra paiement percent promotion"></td>
</tr><tr>
	<td>Extra purchase up</td>
	<td><input name="special_donation_up" maxlength="11" size="11" value="{$special_donation_up}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Extra paiement up promotion"></td>
</tr>
<tr> 
	<td>Academy points on purchase</td>
	<td><input name="ap_don" maxlength="11" size="11" value="{$ap_don}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Give a free percentage of purchased amount in academy points"></td>
</tr>
<tr>
	<td>Acadedmy points reduction</td>
	<td><input name="special_donation_academy" maxlength="11" size="11" value="{$special_donation_academy}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Promotion on academy point purchase"></td>
</tr>
<tr>
	<td>Extra premium time</td>
	<td><input name="special_donation_premium" maxlength="11" size="11" value="{$special_donation_premium}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Promotion extra premium time on purchase"></td>
</tr>
<tr>
	<td>Reduction stardust</td>
	<td><input name="special_donation_stardust" maxlength="11" size="11" value="{$special_donation_stardust}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Promotion on the stardust"></td>
</tr>
<tr>
	<td>Reduction darkmatter cost</td>
	<td><input name="darkmatter_reduc" maxlength="11" size="11" value="{$darkmatter_reduc}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Reduce the cost of construction with dm"></td>
</tr>
<tr>
	<th colspan="2">Collider price</th><th>&nbsp;</th>
</tr>

<tr>
	<td>Collider promotion</td>
	<td><input name="collider_promo" maxlength="11" size="11" value="{$collider_promo}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="promotion in % on the collider price"></td>
</tr>
<tr>
	<th colspan="2">Auctioneer closure</th><th>&nbsp;</th>
</tr>

<tr>
	<td>Auctioneer closure</td>
	<td><input name="auctioneer_closure"{if $auctioneer_closure} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Does the auctioneer close"></td>
</tr>
<tr>
	<td>Auction Items</td>
	<td><input name="auctionExpe"{if $auctionExpe} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Find auctions items on darkmatter missions"></td>
</tr>
<tr>
	<th colspan="2">Allopass Free Code</th><th>&nbsp;</th>
</tr>
<tr>
	<td>Allopass Event</td>
	<td><input name="alloEvent"{if $alloEvent} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Find free allopass codes ingame"></td>
</tr>

<tr>
	<th colspan="2">Prime building</th><th>&nbsp;</th>
</tr>

<tr>
	<td>Prime buildings</td>
	<td><input name="primebuild"{if $primebuild} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Allow to build M7 M19 M32 and MEGADOR types"></td>
</tr>
<tr>
	<th colspan="2">Display options</th><th>&nbsp;</th>
</tr>

<tr>
	<td>New year design</td>
	<td><input name="new_year_status"{if $new_year_status} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Activate special new year design"></td>
</tr>
<tr>
	<td>Cosmonaute design</td>
	<td><input name="cosmonaute_status"{if $cosmonaute_status} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Activate special cosmonaute design"></td>
</tr>
<tr>
	<th colspan="2">Time login bonus</th><th>&nbsp;</th>
</tr>

<tr>
	<td>Time from</td>
	<td><input name="timeFrom" maxlength="11" size="11" value="{$timeFrom}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Start time"></td>
</tr>
<tr>
	<td>Time To</td>
	<td><input name="timeTo" maxlength="11" size="11" value="{$timeTo}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="End time"></td>
</tr>
<tr>
	<td>Bonus reward</td>
	<td><input name="timeReward" maxlength="11" size="11" value="{$timeReward}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Bonus when you login between those times"></td>
</tr>

<tr>
	<th colspan="2">Experience bonuses</th><th>&nbsp;</th>
</tr>

<tr>
	<td>Peacefull experience</td>
	<td><input name="peacefullExp" maxlength="11" size="11" value="{$peacefullExp}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Extra peacefull experience"></td>
</tr>
<tr>
	<td>Combat experience</td>
	<td><input name="combatExp" maxlength="11" size="11" value="{$combatExp}" type="text"></td>
	<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="Extra combat experience"></td>
</tr>
