...
class ShowBanListPage extends AbstractGamePage
{
	...
	function show()
	{
		...
		$sql = "SELECT COUNT(*) as count FROM %%BANNED%% WHERE universe = :universe AND isChat = :ischat ORDER BY time DESC;";
		...
		$sql = "SELECT * FROM %%BANNED%% WHERE universe = :universe AND isChat = :ischat ORDER BY time DESC LIMIT :offset, :limit;";
	...
	function pmList()
	{
		...
		$this->display('page.banList.pmlist.tpl');
	}
}