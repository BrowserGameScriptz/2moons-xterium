...
function ShowLoginPage()
{
	...
	{
		$password	= PlayerUtil::cryptNewPassword('encrypt', $_REQUEST['admin_pw']);

		if ($password == $USER['password']) {
			$session->adminAccess	= 1;
			$GLOBALS['DATABASE']->query("INSERT INTO `uni1_admin_logins` VALUES (null, '".$USER['username']."',  '".$USER['user_lastip']."', '".TIMESTAMP."', '0');");
			HTTP::redirectTo('admin.php');
		}else{
