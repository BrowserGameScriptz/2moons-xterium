	...
	function buildCache()
	{
		...
		foreach($varsResult as $varsRow)
		{
			...
			$pricelist[$varsRow['elementID']]	= array(
				...
				'alliance'		=> array(
					901	=> $varsRow['alliance901'],
					902	=> $varsRow['alliance902'],
					903	=> $varsRow['alliance903'],
					911	=> $varsRow['alliance911'],
				),
				'cost921special'		=> $varsRow['cost921special'],
				'type_gun'		=> $varsRow['type_gun'],
				'costAP'		=> $varsRow['costAP'],
				'arsenal_bonus'		=> $varsRow['arsenal_bonus'],
				'fleetPointExpe'	=> $varsRow['fleetPointExpe'],
			...
			switch($varsRow['class']) {
				...
				break;
				case 800: 
					$reslist['arsenal'][]	= $varsRow['elementID'];
				break;
			}
		}
