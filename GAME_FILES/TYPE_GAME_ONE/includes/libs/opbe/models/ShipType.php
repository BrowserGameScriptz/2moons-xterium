...
class ShipType extends Type
{
     ...
     * @return
     */
    public function __construct($id, $count, $rf, $shield, array $cost, array $costA, $power, $weapons_tech = null, $shields_tech = null, $armour_tech = null)
    {
        ...
        $this->singleLife = COST_TO_ARMOUR * array_sum($costA);
    ...
    public function cloneMe()
    {
        ...
        $tmp = new $class($this->getId(), $this->getCount(), $this->rf, $this->originalShield, $this->cost, $this->costA, $this->originalPower, $this->weapons_tech, $this->shields_tech, $this->armour_tech);
