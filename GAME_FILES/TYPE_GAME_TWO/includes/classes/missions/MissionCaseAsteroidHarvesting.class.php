...
class MissionCaseAsteroidHarvesting extends MissionFunctions implements Mission
{
	...
	{	
        ...
        if($UsedPlanet || !empty($targetPlanet)){
			...
			if($playerInfo['academy_p_b_2_1207'] > 0){
				$academy_p_b_2_1207 = $playerInfo['academy_p_b_2_1207'] * 5;
			}
			...
			$RecyclerCapacity *= 1 + $playerInfo['factor']['ShipStorage'];
			$RecyclerCapacity += $RecyclerCapacity / 100 * $academy_p_b_2_1207 + ($RecyclerCapacity / 100 * $ally_fraction_fleet_capa);
