...
function calculateMIPAJAX($TargetDefTech, $OwnerAttTech, $missiles, $targetDefensive, $firstTarget, $defenseMissles)
{
	...
	$totalAttack 		= $countMissles * $CombatCaps[503]['attack'] * (0.0005 * $OwnerAttTech);
	...
	foreach($targetDefensive as $element => $count)
	{
		...
		$elementStructurePoints = ($pricelist[$element]['cost'][901] + $pricelist[$element]['cost'][902]) / 10;
		$elementStructurePoints += $elementStructurePoints / 100 * $TargetDefTech;
