...
class Config
{
	...
	// Global configkeys 
	protected static $globalConfigKeys	= array('VERSION', 'game_name', 'expe_chance_dark', 'stat', 'stat_level', 'stat_last_update', 'resource_multiplier',
										   ...
										   'chat_closed', 'chat_allowchan', 'chat_allowmes', 'meta_descrip', 'meta_title', 'chat_allowdelmes',
										   ...
										   'disclamerAddress','disclamerPhone','disclamerMail','disclamerNotice', 'admin_name', 'admin_email', 'site_logo', 'site_favicon', 'CampaingStart', 'CampaingEnd',
										   'donation_bonus', 'special_donation_status', 'special_donation_amount', 'special_donation_percent', 'red_button', 'peacefullExp', 'combatExp', 'special_donation_premium', 'special_donation_academy', 'special_donation_stardust', 'darkmatter_reduc', 'collider_promo', 'primebuild', 'auctionExpe', 'OverviewNewsText');
	...
	public function __get($key)
	{
		if (!isset($this->configData[$key])) {
			throw new UnexpectedValueException(sprintf("Unknown config key %s!", $key));
		}
