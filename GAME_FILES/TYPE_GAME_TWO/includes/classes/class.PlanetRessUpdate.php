...
class ResourceUpdate
{
	...
	public function ReBuildCache()
	{
		...
		if($this->PLANET['energy_used'] == 0) {
			...
			$basic_prod_metal_2moons += ($temp[901]['plus'] * ($itemMetal)) * $this->config->resource_multiplier;
			...
			$basic_prod_crystal_2moons += ($temp[902]['plus'] * ($itemCrystal)) * $this->config->resource_multiplier;
			...
			$basic_prod_deuterium_2moons += ($temp[903]['plus'] * ($itemDeuterium)) * $this->config->resource_multiplier;
