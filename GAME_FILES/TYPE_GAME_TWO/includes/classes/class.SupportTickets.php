...
class SupportTickets
{
	...
	public function createAnswer($ticketID, $ownerID, $ownerName, $subject, $message, $status, $adminId = null, $result = null)
	{
		...
		if($status == 1){	
			$sql	= 'UPDATE %%TICKETS%% SET status = :status, adminanswered = :adminanswered WHERE ticketID = :ticketId;';
