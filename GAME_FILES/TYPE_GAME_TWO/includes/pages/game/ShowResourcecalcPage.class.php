...
class ShowResourcecalcPage extends AbstractGamePage
{
	...
	function show()
	{
		...
		if($options == 400){
		$elementId = array(401,402,403,420,405,404,406,416,421,417,418,412,410,413,422,419,414,415,407,408,409,411);
		...
		$elementId = array(212,202,203,204,205,229,209,206,207,217,215,213,211,224,219,225,226,214,216,230,227,228,222,218,221);
		foreach($elementId as $Element){
		...
		$elementId = array(106,108,109,110,111,113,114,115,117,118,120,121,122,123,124,131,132,133,150);
		foreach($elementId as $Element){
