...
class ShowAchievementPage extends AbstractGamePage
{
	...
	function show(){	
		...
		'achievement_tech_1_next_am' => pretty_number(min(20000,round(70 * pow(1.30, $USER['achievement_tech_1'])))),
		'achievement_tech_1_next_points' => pretty_number(min(20000,round(55 * pow(1.30, $USER['achievement_tech_1'])))),
		'achievement_tech_1_current_points' => pretty_number($USER['achievement_tech_1_points']),
		'achievement_tech_2_next_am' => pretty_number(min(20000,round(70 * pow(1.30, $USER['achievement_tech_2'])))),
		'achievement_tech_2_next_points' => pretty_number(min(20000,round(55 * pow(1.30, $USER['achievement_tech_2'])))),
		'achievement_tech_2_current_points' => pretty_number($USER['achievement_tech_2_points']),
		'achievement_tech_3_next_am' => pretty_number(min(20000,round(20 * pow(1.30, $USER['achievement_tech_3'])))),
		'achievement_tech_3_next_points' => pretty_number(min(20000,round(15 * pow(1.30, $USER['achievement_tech_3'])))),
		'achievement_tech_3_current_points' => pretty_number($USER['achievement_tech_3_points']),
		'achievement_tech_4_next_am' => pretty_number(min(20000,round(65 * pow(1.55, $USER['achievement_tech_4'])))),
		'achievement_tech_4_next_points' => pretty_number(min(20000,round(45 * pow(1.55, $USER['achievement_tech_4'])))),
		'achievement_tech_4_current_points' => pretty_number($USER['achievement_tech_4_points']),
		'achievement_tech_5_next_am' => pretty_number(min(20000,round(35 * pow(1.40, $USER['achievement_tech_5'])))),
		'achievement_tech_5_next_points' => pretty_number(min(20000,round(25 * pow(1.40, $USER['achievement_tech_5'])))),
		'achievement_tech_5_current_points' => pretty_number($USER['achievement_tech_5_points']),
		'achievement_tech_6_next_am' => pretty_number(min(20000,round(45 * pow(1.40, $USER['achievement_tech_6'])))),
		'achievement_tech_6_next_points' => pretty_number(min(20000,round(30 * pow(1.40, $USER['achievement_tech_6'])))),
		'achievement_tech_6_current_points' => pretty_number($USER['achievement_tech_6_points']),
		'achievement_tech_7_next_am' => pretty_number(min(20000,round(30 * pow(1.45, $USER['achievement_tech_7'])))),
		'achievement_tech_7_next_points' => pretty_number(min(20000,round(20 * pow(1.45, $USER['achievement_tech_7'])))),
		'achievement_tech_7_current_points' => pretty_number($USER['achievement_tech_7_points']),
		'achievement_tech_8_next_am' => pretty_number(min(20000,round(15 * pow(1.30, $USER['achievement_tech_8'])))),
		'achievement_tech_8_next_points' => pretty_number(min(20000,round(10 * pow(1.30, $USER['achievement_tech_8'])))),
		'achievement_tech_8_current_points' => pretty_number($USER['achievement_tech_8_points']),
		'achievement_tech_9_next_am' => pretty_number(min(20000,round(25 * pow(1.40, $USER['achievement_tech_9'])))),
		'achievement_tech_9_next_points' => pretty_number(min(20000,round(20 * pow(1.40, $USER['achievement_tech_9'])))),
		'achievement_tech_9_current_points' => pretty_number($USER['achievement_tech_9_points']),
		'achievement_tech_10_next_am' => pretty_number(min(20000,round(20 * pow(1.30, $USER['achievement_tech_10'])))),
		'achievement_tech_10_next_points' => pretty_number(min(20000,round(13 * pow(1.30, $USER['achievement_tech_10'])))),
		...
		'achievement_build_1_next_am' => pretty_number(min(20000,round(7 * pow(1.35, $USER['achievement_build_1'])))),
		'achievement_build_1_next_points' => pretty_number(min(20000,round(1 * pow(1.35, $USER['achievement_build_1'])))),
		'achievement_build_1_current_points' => pretty_number($USER['achievement_build_1_points']),
		'achievement_build_2_next_am' => pretty_number(min(20000,round(7 * pow(1.36, $USER['achievement_build_2'])))),
		'achievement_build_2_next_points' => pretty_number(min(20000,round(1 * pow(1.385, $USER['achievement_build_2'])))),
		'achievement_build_2_current_points' => pretty_number($USER['achievement_build_2_points']),
		'achievement_build_3_next_am' => pretty_number(min(20000,round(7 * pow(1.40, $USER['achievement_build_3'])))),
		'achievement_build_3_next_points' => pretty_number(min(20000,round(2 * pow(1.3834, $USER['achievement_build_3'])))),
		'achievement_build_3_current_points' => pretty_number($USER['achievement_build_3_points']),
		'achievement_build_4_next_am' => pretty_number(min(20000,round(28 * pow(1.15, $USER['achievement_build_4'])))),
		'achievement_build_4_next_points' => pretty_number(min(20000,round(3 * pow(1.342, $USER['achievement_build_4'])))),
		'achievement_build_4_current_points' => pretty_number($USER['achievement_build_4_points']),
		'achievement_build_5_next_am' => pretty_number(min(20000,round(31 * pow(1.16, $USER['achievement_build_5'])))),
		'achievement_build_5_next_points' => pretty_number(min(20000,round(3 * pow(1.371, $USER['achievement_build_5'])))),
		'achievement_build_5_current_points' => pretty_number($USER['achievement_build_5_points']),
		'achievement_build_6_next_am' => pretty_number(min(20000,round(33 * pow(1.17, $USER['achievement_build_6'])))),
		'achievement_build_6_next_points' => pretty_number(min(20000,round(3 * pow(1.41, $USER['achievement_build_6'])))),
		'achievement_build_6_current_points' => pretty_number($USER['achievement_build_6_points']),
		'achievement_build_7_next_am' => pretty_number(min(20000,round(80 * pow(1.55, $USER['achievement_build_7'])))),
		'achievement_build_7_next_points' => pretty_number(min(20000,round(30 * pow(1.55, $USER['achievement_build_7'])))),
		'achievement_build_7_current_points' => pretty_number($USER['achievement_build_7_points']),
		'achievement_build_8_next_am' => pretty_number(min(20000,round(35 * pow(1.30, $USER['achievement_build_8'])))),
		'achievement_build_8_next_points' => pretty_number(min(20000,round(6 * pow(1.315, $USER['achievement_build_8'])))),
		'achievement_build_8_current_points' => pretty_number($USER['achievement_build_8_points']),
		'achievement_build_9_next_am' => pretty_number(min(20000,round(80 * pow(1.40, $USER['achievement_build_9'])))),
		'achievement_build_9_next_points' => pretty_number(min(20000,round(8 * pow(1.40, $USER['achievement_build_9'])))),
		'achievement_build_9_current_points' => pretty_number($USER['achievement_build_9_points']),
		'achievement_build_10_next_am' => pretty_number(min(20000,round(40 * pow(1.30, $USER['achievement_build_10'])))),
		'achievement_build_10_next_points' => pretty_number(min(20000,round(7 * pow(1.315, $USER['achievement_build_10'])))),
