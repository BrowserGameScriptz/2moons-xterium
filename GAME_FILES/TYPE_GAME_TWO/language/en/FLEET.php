...
$LNG['sys_mess_spy_report'] 				= "Intelligence report - [%d:%d:%d]";
...
$LNG['sys_expe_found_dm_1_1']				= 'The expedition has succeeded to capture some <font color="#913399">dark matter</font>.';
$LNG['sys_expe_found_dm_1_2']				= 'Our expedition has discovered a ghost ship, which transported a small amount of <font color="#913399">dark matter</font>. Although we have not been able to find notes on what has happened to the original crew, our technicians, however, managed to get hold of the <font color="#913399">dark matter</font>.';
$LNG['sys_expe_found_dm_1_3']				= 'We met a strange alien on board of a little ship which left a little container for us in exchange for a couple of simple, mathematical calculations with <font color="#913399">dark matter</font>.';
$LNG['sys_expe_found_dm_1_4']				= 'We have found the remains of an alien ship. There was a little container on board with <font color="#913399">dark matter</font>!';
$LNG['sys_expe_found_dm_1_5']				= 'The expedition followed some strange signals and discovered an asteroid, in the core was a small amount of <font color="#913399">dark matter</font> detected. The asteroid was taken on board and the researchers extracted the <font color="#913399">dark matter</font>.';
...
$LNG['sys_expe_found_ships_1_1']			= '<font color="#d2a95f">We have discovered the remains of a predecessor expedition! Our technicians look, whether they get some of the wrecks working again.</font>';
$LNG['sys_expe_found_ships_1_2']			= '<font color="#d2a95f">We have found a deserted pirate base. Some old ships are still located in the hangar. Our technicians look, whether still some of the ships are useable.</font>';
$LNG['sys_expe_found_ships_1_3']			= '<font color="#d2a95f">Our expedition found a planet which was almost completly destroyed by wars. Various shipwrecks drifted in the orbit. The technicians try to repair some of these. Perhaps we also find information on what has happened here.</font>';
$LNG['sys_expe_found_ships_1_4']			= '<font color="#d2a95f">The expedition stumbled upon an old starbase which seems to be abandoned for an eternity. A couple of ships were found in the hangar of the fortress. The technicians managed to get some of them flying again.</font>';
...
$LNG['sys_expe_attack_1_1_1'] 				= '<font color="#db5504">A space pirate in despair tried to commandeer our expeditions fleet.</font>';
$LNG['sys_expe_attack_1_1_2'] 				= '<font color="#db5504">Some primitive barbarians attacked us with spaceships, at least their ships were in horrible conditions. If the firepower was a serious threat we would have beene forced to reply with our firepower.</font>';
$LNG['sys_expe_attack_1_1_3'] 				= '<font color="#db5504">We have intercepted a couple of radio messages of some very drunk pirates. We apparently will be attacked.</font>';
$LNG['sys_expe_attack_1_1_4'] 				= '<font color="#db5504">We had to fight against some pirates who fortunately were outnumbered against us.</font>';
$LNG['sys_expe_attack_1_1_5'] 				= '<font color="#db5504">Our fleet reports that a certain Moa Tikarr and his crew requested the unconditional surrender of our fleet. If they are serious, they will have to find out that we can defend ourself very well.</font>';
$LNG['sys_expe_attack_1_2_1'] 				= '<font color="#db5504">Your expedition fleet had an unforseen encounter with some spacepirates.</font>';
$LNG['sys_expe_attack_1_2_2'] 				= '<font color="#db5504">We flew into an ambush of some starpirates! Unfortunately a fight was unavoidable.</font>';
$LNG['sys_expe_attack_1_2_3'] 				= '<font color="#db5504">The call for help of another expeditionfleet turned out to be a trap of some cunning pirates. A battle was unavoidable.</font>';
$LNG['sys_expe_attack_1_3_1'] 				= '<font color="#db5504">The intercepted signals did not came from some unknown aliens but of a secret pirate base! The pirates were not very happy by our presence in their sector</font>.';
$LNG['sys_expe_attack_1_3_2'] 				= '<font color="#db5504">The expedition fleet reported heavy fights with unidentified pirate ships</font>!';
$LNG['sys_expe_attack_2_1_1'] 				= '<font color="#db5504">Your expedition fleet had an uninteresting first contact with new aliens</font>.';
$LNG['sys_expe_attack_2_1_2'] 				= '<font color="#db5504">Some strange ships have attacked the expedition fleet without early warning</font>!';
$LNG['sys_expe_attack_2_1_3'] 				= '<font color="#db5504">Our expedition was attacked by a small group of unknown ships</font>!';
$LNG['sys_expe_attack_2_1_4'] 				= '<font color="#db5504">The expedition fleet reports contact with unknown ships. The radio messages are not able to be decoded, however, the strange ships seem to activate their weapons</font>.';
$LNG['sys_expe_attack_2_2_1'] 				= '<font color="#db5504">An unknown specie attacks our expedition</font>!';
$LNG['sys_expe_attack_2_2_2'] 				= '<font color="#db5504">Your expedition fleet has apparently violated the territory of a previously unknown but highly aggressive alien race</font>.';
$LNG['sys_expe_attack_2_2_3'] 				= '<font color="#db5504">The connection with our expedition fleet was disconnected abruptly. The last what we heard of the fleet was that it was taking heavy fire - the aggressors could not be identified.</font>';
$LNG['sys_expe_attack_2_3_1'] 				= '<font color="#db5504">Your expedition has come across an alien invasion fleet and reports massive battles</font>!';
$LNG['sys_expe_attack_2_3_2'] 				= '<font color="#db5504">A large group of crystalline ships of unknown origin is on a direct collision course with our expedition fleet. We must prepare ourself for the worst</font>.';
$LNG['sys_expe_attackname_1']				= 'Pirates'; 	
$LNG['sys_expe_attackname_2'] 				= 'Aliens'; 	
$LNG['sys_expe_back_home'] 					= 'Your fleet has returned from the expedition.<br>It deliveres %s<font color="#775e5d"> %s</font>, %s<font color="#5892e7"> %s</font>,  %s<font color="#33ac5d"> %s</font> and %s<font color="#913399"> %s</font>.';
...
$LNG['sys_recy_gotten'] 					= 'Fleet arrived at it\'s destination. Recyclers collected %s %s and %s %s';
$LNG['sys_recy_gotten_2'] 					= 'Fleet arrived at it\'s destination. Recyclers collected %s %s, %s %s and %s %s';
$LNG['sys_recy_gotten_3'] 					= 'One of your recyclers reaches the debris %s. Recyclers collected %s %s and %s %s';
$LNG['sys_gain'] 				  			= 'Profit';
