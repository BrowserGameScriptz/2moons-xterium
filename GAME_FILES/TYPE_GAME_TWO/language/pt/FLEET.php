...
$LNG['sys_mess_spy_report'] 			= "Relatório de espionagem - [%d:%d:%d]";
...
$LNG['sys_recy_gotten_3'] 					= 'Um dos seus recicladores atinge os escombros %s. Recicladores coletados %s %s e %s %s';
