...
150 => 'Tecnolog&iacute;a Recyclaje',
...
707 => 'Coordinaci&oacute;n de flota',
	...
	809 => 'Medium shields',
	810 => 'Heavy shields',
	811 => 'Combustion engine',
	812 => 'Impulse engine',
	813 => 'Hyperspace engine',
	814 => 'Upgrade production of metal',
	815 => 'Upgrade production of crystal',
	816 => 'Upgrade production of deuterium',
	817 => 'Upgrade light conveyor',
	818 => 'Upgrade medium conveyor',
	819 => 'Upgrade heavy conveyor',
...
1 => 'Metal is a fundamental resource, invested in the foundation of your empire. With the increase in production of metal produced more products for use in construction of buildings, ships and missile systems and research. Deep mines require more energy to maximize production of the metal. Since the metal is the most common of all available resources, its cost is considered to be the lowest of all the resources for trade and exchange.
	...
	7 => 'El muelle WOG ofrece la posibilidad de reparar los barcos que se han convertido en un naufragio en el transcurso de una batalla. Esto puede ser completado con condiciones más favorables que una nueva construcción en el astillero y tiene un tiempo máximo de reparación de 48 horas.
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	...
	50 => 'Con cada nivel aumenta la probabilidad de encontrar Stardust mejorando los sensores en barcos especiales.
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Con cada nivel aumenta la probabilidad de encontrar Stardust en 0.5%.</font>',
	51 => 'El módulo táctil muestra el movimiento de todas las flotas de alianzas enemigas.
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Con cada nivel, el radio de escaneo aumenta en 3 sistemas.</font>',
	52 => 'El Centro de Investigación con cada nivel acelera la investigación de tecnologías en un 3% y reduce en un 1% la cantidad necesaria de combustible para el vuelo de los buques.',
...
<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br> 
<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Cada 5 nivel de esta tecnología aumenta el número de lanzamiento de una ola de asteroides </font><br> 
<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Cada nivel de esta tecnología aumenta los recursos extraídos de asteroides 1% </font><br>
<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Cada nivel de esta tecnología aumenta el valor de la materia oscura del 3% con colectores </font>',
 ...
 <br><br><font color="#BC8F8F"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Available with the purchase in the premium shop</font>',
  ...
  <font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> It is used to destroy the enemy\'s defense. <br><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> After the destruction of the interplanetary defense missiles, defense is not restored.',
	...
	601 => 'Geologist - a recognized expert in the aster mineralogy and crystallography. He and his team of metallurgists and chemists interplanetary government supports the development of new resources and optimize their treatment.',
	602 => 'Admiral - a test of war veteran and a brilliant strategist. Even in the hottest battles, he does not lose the review and maintains contact with his subordinates admirals. A wise ruler can rely on him in battle, and thus be used to fight more ships.',
	603 => 'Engineer - a specialist in energy management. In peacetime, it increases the level of energy networks in the colonies. In the event of an attack, he supplies the energy systems of planetary protection and prevents overload, which leads to a much smaller degree of loss in battle.',
	604 => 'Technocrats - is brilliant scientists, and they can always be found where the end face of the technically possible. Their code will never be able to unravel any normal person, and by their presence they inspire scientists empire.',
	605 => 'Constructor - an indispensable expert in any building. Through research and experiments related to design decisions, supervision of construction and scientific approach, to accelerate the construction and increase the efficiency of the builders.',
	606 => 'The scientist is also included in the union of technocrats. They specialize in reducing learning time studies.',
	607 => 'Work guardian is entrusted to him the resources are not wasted. His mind is allowed to come up out, he created a new technique of storage resources.',
	608 => 'Defence Minister - a member of the Imperial Army. His merit in his work, which enables him to build a great protection against enemy fleets as soon as possible.',
	609 => 'Emperor impressed with your work that you provide to the empire. As a thank you, he will allow you to use the most powerful protection. <br> <br> Opportunity to build Planetary Shield Dome.',
	610 => 'Scout - a mysterious man. Nobody has ever seen his true face, and shall not see until he dies.',
	611 => 'Commander has repeatedly proved itself in modern warfare. Due to the simplified structure of your orders can be executed faster, which will allow you to maintain control over your entire empire. You will be able to develop strategies to always be one step ahead of the enemy.',
	612 => 'Destroyer - an employee without mercy. He destroys everything on the planet, just because of the fact that he likes it. In managing the Death Star can destroy entire moon.
  <br><br>
  <font color="red"> Opens mission Destruction</font>',
	613 => 'General - is an honorable person who serves in the army for many years. Countless maneuvers general strategy designed to optimize the speed of all types of vehicles under the most unexpected circumstances.',
	614 => 'The emperor found in you the indisputable quality of the conqueror. It offers you to become raiders. Raider - the highest rank of the Imperial Army.
  <br><br>
  It opens the possibility of building:<font color="red"> "Battleship class O\'Neill"</font>',
	615 => 'As it turned out, you - the great conqueror of the universe. The time has come for you to take the place that you deserve.
  <br><br>
  It opens the possibility of building:<font color="red"> "Orbital base"</font>',
...
109 => ' Wapeon technology is a key technology research and crucial to your survival against enemy empires. Weapons Technology explores the weapons systems on ships and enemy defenses become less effective. 
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span> Increases attack power of defense and fleet. Every level add 1% to the general bonus.</font>
	',
		110 => ' With the invention of the generator\'s magnetosphere, scientists have learned that the artificial shield can be adjusted to protect the crew on the spacecraft not only from the harsh solar radiation in deep space, but also for protection from enemy fire during the attack. Once the researchers worked out the technology, magnetospheric generator has been installed on all ships and defense systems. 
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>Increases shields power of fleet and defense. Every level add 1% to the general bonus. </font>
	<br><font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>Increases shields power of fleet and defense. Every level add <font onclick="$(\'#id_11\').slideToggle();return false" style=" cursor: help;"><b>table</b></font> to the ships. </font>
	<div style="display: none;clear: both;" id="id_11">
	<table class="tablesorter ally_ranks">
 <tbody><tr>
     <th class="gray_stripe"><b>Type</b></th>
        <th class="gray_stripe"><b>% per level</b></th>
    </tr>
	<tr><td>Light</td><td>75%</td></tr>
	<tr><td>Medium</td><td>60%</td></tr>
	<tr><td>Heavy</td><td>40%</td></tr>
	<tr><td colspan="2">Until level 50</td></tr>
	</tbody></table>
</div>',
	111 => 'The space deep space - severely. Fleets are faced not only with the intensity of solar radiation, but also from the perspective of the impact of space debris, or destruction by fire of the enemy in battle. Opening of the aluminum-lithium alloy of titanium carbide, gave some degree of protection crews.
	<br><br>
	<span style="line-height: 17px; color:#3399CC;"><span style=" margin-left:0px; margin-right:4px; cursor:default; float:left;" class="interrogation">i</span> Informacion util:</span><br>
	<font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>Increases armor power of fleet and defense. Every level add 1% to the general bonus.</font>
	<br><font color="#00FF00"><span style=" margin-left:9px; margin-right:4px; cursor:default; float:left;">•</span>Increases armor power of fleet and defense. Every level add <font onclick="$(\'#id_11\').slideToggle();return false" style=" cursor: help;"><b>table</b></font> to the ships. </font>
	<div style="display: none;clear: both;" id="id_11">
	<table class="tablesorter ally_ranks">
 <tbody><tr>
     <th class="gray_stripe"><b>Type</b></th>
