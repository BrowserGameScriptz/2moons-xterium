...
{/foreach}
<tr style="height:22px " class="fl_fllets_rows">
	<td style="text-align: left;text-align: left;line-height: 20px;"><img src="//static.{$my_game_url}/media/gamemedia/styles/theme/gow/gebaeude/131.gif" style="height: 20px;width: 20px;float: left;margin-right: 4px;"><a href="#" onclick="return Dialog.info(131)" title="({$LNG.tech.131},{$LNG.tech.132},{$LNG.tech.133})">{$LNG.lv_technology} {$LNG.peace_2}</a></td>
...
<tr style="height:22px" class="fl_fllets_rows">
	<td style="text-align: left;text-align: left;line-height: 20px;"><img src="//static.{$my_game_url}/media/gamemedia/styles/images/auction/1.gif" style="height: 20px;width: 20px;float: left;margin-right: 4px;"><a href="/game.php?page=auctioneer&mode=inventory" target="_blank" title="{$LNG.auctioneer_26}">{$LNG.auctioneer_24}</a></td>
	<td><span style="color:{if $itemProduction.901 > 0}#a47d7a{elseif $itemProduction.901 < 0}brown{else}#a47d7a;{/if}">{$itemProduction.901|number}{if $ItemTiMeb > 0}<img src="//static.{$my_game_url}/media/gamemedia/styles/images/mark.png" class="tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'>{$LNG.auctioneer_24}</th></tr> <tr><td><img src='//static.{$my_game_url}/media/gamemedia/styles/images/auction/1.gif' style='height: 20px;width: 20px;float: left;margin-right: 4px;'title='{$LNG.auctioneer_booster.1}'></td><td>{$ItemTiMe}</td> </tr></tbody></table>" style="margin-left: 2px;width: 12px;height: 12px; margin-bottom:3px" value="{$itemProduction.901|number}">{/if} </span></td>
	<td><span style="color:{if $itemProduction.902 > 0}#5ca6aa{elseif $itemProduction.902 < 0}brown{else}#5ca6aa{/if}">{$itemProduction.902|number}{if $ItemTiCrb > 0}<img src="//static.{$my_game_url}/media/gamemedia/styles/images/mark.png" class="tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'>{$LNG.auctioneer_24}</th></tr> <tr><td><img src='//static.{$my_game_url}/media/gamemedia/styles/images/auction/1.gif' style='height: 20px;width: 20px;float: left;margin-right: 4px;' title='{$LNG.auctioneer_booster.4}'></td><td>{$ItemTiCr}</td> </tr></tbody></table>" style="margin-left: 2px;width: 12px;height: 12px; margin-bottom:3px" value="{$itemProduction.902|number}">{/if}</span></td>
	<td><span style="color:{if $itemProduction.903 > 0}#339966{elseif $itemProduction.903 < 0}brown{else}#339966{/if}">{$itemProduction.903|number} {if $ItemTiDeb > 0}<img src="//static.{$my_game_url}/media/gamemedia/styles/images/mark.png"class="tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'>{$LNG.auctioneer_24}</th></tr> <tr><td><img src='//static.{$my_game_url}/media/gamemedia/styles/images/auction/1.gif' style='height: 20px;width: 20px;float: left;margin-right: 4px;' title='{$LNG.auctioneer_booster.7}'></td><td>{$ItemTiDe}</td> </tr></tbody></table>" style="margin-left: 2px;width: 12px;height: 12px; margin-bottom:3px" value="{$itemProduction.903|number}">{/if}</span></td>
...
<tr style="height:22px" class="fl_fllets_rows">
	<td style="text-align: left;text-align: left;line-height: 20px;"><img src="//static.{$my_game_url}/media/gamemedia/styles/theme/gow/gebaeude/22.gif" style="height: 20px;width: 20px;float: left;margin-right: 4px;">{$LNG.rs_storage_capacity}</td>
