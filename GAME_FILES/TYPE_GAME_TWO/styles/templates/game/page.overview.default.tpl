...
<span onclick="$('#guaglione').slideToggle(0);" class="openCloseDetails"><img src="https://gf3.geo.gfsrv.net/cdnb6/577565fadab7780b0997a76d0dca9b.gif" height="16" width="16" class="flov7"></span>
    ...
    <div id="big_panet" style="background: url(//static.warofgalaxyz.com/media/gamemedia/styles/theme/gow/planeten/control_room_world2.png) no-repeat, url(//static.warofgalaxyz.com/media/gamemedia/styles/theme/gow/planeten/{$planetimage}.jpg) no-repeat ; background-size:cover;margin-top: 10px;">
 ...
 <div class="palnet_pianeta_titoloa palnet_pianeta_titolo" {if $gal6modOver == 1}style="top:50px;"{/if}>
	       ...
	       <a href="#" class="palanetarium_linck infouniov tooltip" style="top: 5px;"data-tooltip-content="<table class='reducefleet_table' style='width:100%'><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-datestart.png' style='width:15px'></td><td class='reducefleet_name_ship'>Date of start: <B>17/02/2018</B></td></tr><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-gamespeed.png' style='width:15px'></td><td class='reducefleet_name_ship'>{$LNG.in_base_speed}: <B>x10.000</B></td></tr><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-resources.png' style='width:15px'></td><td class='reducefleet_name_ship'>{$LNG.ally_fractions_34}: <B>x8.000</B></td></tr><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-expedition.png' style='width:15px'></td><td class='reducefleet_name_ship'>{$LNG.ally_fractions_39}: <B>X5</B></td></tr><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-rocket.png' style='width:15px'></td><td class='reducefleet_name_ship'>{$LNG.ally_fractions_15}: <B>x12</B></td></tr><tr><td <td class='reducefleet_img_res' style='width:15px'><img src='//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/o-energy.png' style='width:15px'></td><td class='reducefleet_name_ship'>{$LNG.ally_fractions_35}: <B>X1</B></td></tr></table><table class='reducefleet_table"></a>
...
<div name="situation_irreguliere" class="palnet_block_push palnet_luna_push blink_me1" {if $gal6modOver == 1}style="top:50px;"{/if}>
  ...
  <div style="width: 163.5px;max-width: 163.5px;float: left; height: 20px; overflow: hidden;">{if $buildBusy.tech}<img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/tech.png"><span> {$LNG.tech[$buildBusy.tech['id']]} ({$buildBusy.tech['level']|number})</span>{/if}</div>
   <div style="width: 163.5px;max-width: 163.5px;margin-left:10px;float: left;height: 20px; overflow: hidden;">{if $buildBusy.buildings} <img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/build.png"><span> {$LNG.tech[$buildBusy.buildings['id']]} ({$buildBusy.buildings['level']|number})</span>{/if}</div>
    <div style="width: 163.5px;max-width: 163.5px;margin-left:10px;float: left;height: 20px; overflow: hidden;">{if $buildBusy.fleet} <img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/fleet.png"><span> {$LNG.tech[$buildBusy.fleet['id']]} ({$buildBusy.fleet['level']|number})</span>{/if}</div>
   <div style="width: 148px;height: 80%;margin-left:10px;float: left;height: 20px; overflow: hidden;">{if $buildBusy.defense} <img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/shield.png"><span> {$LNG.tech[$buildBusy.defense['id']]} ({$buildBusy.defense['level']|number})</span>{/if}</div>
                    </div>
					{/if}
			...
			<a href="game.php?page=createMoon" style="color: #5ca6aa;text-decoration: blink;font-weight: bold;font-size: 13px;"><img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/crealuna.png" style="height: 14px;width: 14px;"> {$LNG.over_creamoon}</a>
		</div>
		{elseif $planet_type == 1}
		<a href="game.php?page=overview&amp;cp={$Moon.id}&amp;re=0" class="palnet_block_info palnet_luna_info" title="">
            <img src="//static.warofgalaxyz.com/media/gamemedia/styles/theme/gow/planeten/moon.png" alt=" ({$LNG.planet_type.3})" height="60" width="60">
        </a>
		{else}
		<div class="palnet_block_info palnet_luna_info">
                <a href="game.php?page=kollaider" style="color: #5ca6aa;text-decoration: blink;font-weight: bold;font-size: 13px;"><img src="//static.warofgalaxyz.com/media/gamemedia/styles/images/iconav/miniera.png" style="height: 14px;width: 14px;"> {$LNG.over_collider}</a>
            </div>
		{/if}
