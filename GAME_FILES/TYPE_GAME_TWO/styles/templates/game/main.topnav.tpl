	...
	{/if}
	{if $showCronLocked == 1}
	<div class="infobox">The automated expedition cronjob reported a failure. <a href="game.php?page=overview&mode=cronLost" style="color:green;">Click here to restart</a> it and earn 5.000 antimatter as gift from the administration team !</div>
	{/if}
