...
define('SHIELD_CELLS', 1000000); //how many cells a ship's shield should contain. Carefull to edit: more cells = better accuracy but less bounces in some cases.
...
define('ROUNDS', 10); //how many rounds a battle have, no limits.
define('SHIELDS_TECH_INCREMENT_FACTOR', 0.01); //how much a level increase the shield, in percentage from 0 to 1.
define('ARMOUR_TECH_INCREMENT_FACTOR', 0.01); //how much a level increase the armour, in percentage from 0 to 1.
define('WEAPONS_TECH_INCREMENT_FACTOR', 0.01); //how much a level increase the weapon, in percentage from 0 to 1.
define('COST_TO_ARMOUR', 0.1); //how much cost equal the armour, from 0 to 1. 1 means the ships/defenses armour equal its cost.
define('MIN_PROB_TO_EXPLODE', 0); //minimum probability at one the ships/defenses can explode, from 0 to 1. 1 means that the ship/def can explode only when they lost all hp.
define('DEFENSE_REPAIR_PROB', (mt_rand(50,70)/100)); //probability to repair defenses. From 0 to 1, 1 means that defenses are always rebuilt.
...
define('ONLY_FIRST_AND_LAST_ROUND', true); //This option is usefull to decrease RAM usage, but the battle report will not contain all rounds.

/*** After-battle constants, default as Ogame ***/
define('REPAIRED_DO_DEBRIS',false);
//define('SHIP_DEBRIS_FACTOR', (mt_rand(30,50)/100)); //Percentage of debris generated from destroyed defenses.
//define('DEFENSE_DEBRIS_FACTOR', 0); //Percentage of debris generated from destroyed ships.
define('POINT_UNIT', 1000000); //Ogame point = 1000 resources.
define('MOON_UNIT_PROB', 100000000);
define('MAX_MOON_PROB', 20); //max probability to moon creation.
define('MOON_MIN_START_SIZE', 2000);
define('MOON_MAX_START_SIZE', 9500);
