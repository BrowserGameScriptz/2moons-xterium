...
class ShowVertifyPage extends AbstractLoginPage
{
	...
	private function _activeUser()
	{
		...
		list($userID) = PlayerUtil::createPlayer($userData['universe'], $userData['userName'], $userData['password'], $userData['email'], $userData['language']);
	...
	function show()
	{
		...
		HTTP::redirectTo('index.php?page=registraok');
	}
