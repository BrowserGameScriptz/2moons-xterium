...
801 => 'Lazer silahları',
802 => 'Ion top',
803 => 'Plazma silahları',
804 => 'Yerçekimi silahı',
805 => 'Hafif zırh',
806 => 'Orta zırh',
807 => 'Ağır zırh',
808 => 'Işık kalkanlar',
...
812 => 'Darbe motor',
813 => 'Hiperuzay motor',
814 => 'metal üretimini yükseltme',
815 => 'kristal üretimini yükseltme',
816 => 'döteryum üretimini yükseltme',
817 => 'Yükseltme ışık konveyör',
818 => 'orta konveyör Yükseltme',
819 => 'ağır konveyör Yükseltme',
...
124 => 'Kesif Teknigi sayesinde bazi kordinatlara kesifler duzenlenebilir. Bu kesiflerden Filo, Maden, Karanlik madde kazanilir. En kotu ihtimal de bu seferlerde bazen giden filolarin geri donmeme olasiligidir. Ayrica bu arastirma sayesinde belirlenen koloni/Somurge disinda extra gezegenler alinabilir. (Kademe 1=1 som. 3=2 som. 5=3 som.) ',
	125 => 'Kardeşlik - ittifak üyeleri arasında benzersiz bir teknoloji karşılıklı yardımlaşma. teknolojinin artan seviyesi ile kaynakların katkısını artırmak mümkündür. ',
...
229 => 'Işık sınıfın M-7 asal filo, silah geliştirmek için yeteneği ile kendi sınıfında tek filosu. Yangının parçası alarak, düşman kuvvetlerini oyalayarak için mükemmeldir. çok sayıda müthiş bir güç.',
	230 => 'Ağır sınıfın M-32 asal filosu, daha iyi bir çevre koruma asal filoları vardır. Yapısında için panoları büyük bir stok ve kurtarma yüzdesini vardır. büyük savaşlar ortalama filo ve asa ateş gücü karşısında mükemmel.',
...
414 => ' "Kanyon" çekimsel silah geliştirmek için başlatılan ve tam bir başarı oldu. alet, enerji ve malzeme maliyetleri, hem de yüksek yerçekimi teknolojisinin bir sürü gerektirir.',
415 => 'Kuantum silah, özellikle düşman filosu amiral gemileri, yani ana ağır araçların imhası için tasarlanmış. Çalışma prensibi ferromanyetik durumuna paramanyetik durumundan manyetik alan zayıf olduğunda madde, başka bir termodinamik fazdan geçer araçları dayanır.',
416 => 'Bilim adamları yakın zamanda bir silah olarak döteryum kullanmak mümkün olduğunu göstermiştir. Bir süre sonra hidrojenin bir enstrüman oldu. deri veya geminin kalkanlar ile temas esnasında, döteryum zayıflatmaktadır bir ivme var.',
417 => 'Dora Gun orta sınıfın en güçlü korunmasıdır. Çünkü gücünün, bir elektromanyetik darbe ile düşman donanmaları yok edebilirsiniz, ancak, silah çok hızlı overheats ve enerji bir sürü gerektirir, bu yüzden dağlarda yerleştirilmiş ve yanlarında olan bunun, çünkü her zaman bir güç vardır bitki.',
418 => 'Foton top prototipi Proton silah oldu. Nispeten düşük fiyat ve güçlü voleybolu yangın foton top, küresel savunma için kaçınılmaz hale gelmiştir.',
419 => 'parçacıkların yayıcı - Bu savunma bu tür oluşturmak için bilim adamları ve mühendislerin uzun, zahmetli çalışmanın sonucudur. Bu gezegenin ya da gemilerin hemen hemen bilinen tüm türleri püskürtmek ayın çok amaçlı koruma bu pek türlerinden birisidir. Bu güç gemi partiküller halinde böler, ile temas halinde olan güçlü bir ışına plazma, çekimsel ve iyon silah kombinasyonunda yatmaktadır.',
420 => 'Megador Slim - yürür asal savunma ışık sınıfı silah iki tür kullanır. Bu başbakan ve M-7 filosu gibi hafif filo türleri ile baş edebiliyor. diğer akciğer savunma sınıfı ile karşılaştırıldığında bombardıman uçakları, karşı iyi performans gezegenlerarası füzeleri, daha az hasar alır.',
421 => 'Megador Demir - orta sınıfın ana savunma, silah üç tip kullanır yürür. Etkili bir ortalama filo tip baş orta sınıfın tek savunma da bombardıman uçaklarına karşı iyi bir skorostrel vardır, Destroyer karşı skorostrel vardır. Diğer orta sınıf savunma ile karşılaştırıldığında, bombardıman uçakları ve destroyer karşı iyi performans, gezegenlerarası füzelerden daha az hasar alır.',
422 => 'Megador Büyük - yürür asal savunma ağır sınıf, silah üç tip kullanır. Etkili M-19 asal filosu dahil olmak üzere, ortalama filo tipi baş. Diğer savunma ağır sınıfına göre bombardıman uçakları ve destroyer, karşı iyi performans gezegenlerarası füzeleri, daha az hasar alır.',
