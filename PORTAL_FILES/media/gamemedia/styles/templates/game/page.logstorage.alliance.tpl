...
<div id="ally_content" class="conteiner">
    <div class="gray_stripe" style="margin-bottom:5px;">
        ...
        (<a href="game.php?page=alliance&amp;mode=logStorageFull">{$LNG.allian_12}</a> | 
         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=1" {if $timeShow <= 1}style="color:#666;"{/if}>{$LNG.allian_13}</a> | 
         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=2" {if $timeShow == 2}style="color:#666;"{/if}>{$LNG.allian_14}</a> | 
         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=3" {if $timeShow == 3}style="color:#666;"{/if}>{$LNG.allian_15}</a>)
