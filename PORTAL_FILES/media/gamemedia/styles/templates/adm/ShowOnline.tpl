				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">INGAME INFORMATION</span> - Users Online</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="admin.php?page=usersonline">INGAME INFORMATION</a></li>
							<li>Users Online</li>
						</ul>
				...
				<div class="content">
							...
							{foreach $OnlineList as $userID => $onlineRow} 
								<tr>
									...
									<td>{if $onlineRow.bana == 0}<span class="label label-success">Not banned</span>{else}<span class="label label-danger">Account banned</span>{/if}</td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a href="?page=usersonline&amp;delete=user&amp;user={$userID}" onclick="return confirm('{$LNG.ul_sure_you_want_dlte} - {$onlineRow.username}');"><i class="glyphicon glyphicon-remove"></i> Delete Account</a></li>
												</ul>
											</li>
										</ul>
									</td>
